...
from prompts import logistics_prompt, customer_support_prompt, tracking_prompt
...
async def ask_question(request: QueryRequest):
    try:
        ...
        # Default prompt and type
        prompt = logistics_prompt
        prompt_type = "logistics"

        # Choose prompt based on question content
        lower_q = question.lower()
        if "tracking" in lower_q or "ups" in lower_q:
            prompt = tracking_prompt
            prompt_type = "tracking"
        elif "where" in lower_q or "when" in lower_q or "how do I get my package" in lower_q:
